...
public class OrderBLImpl implements OrderBL {
    ...
    //  coffee = coffeeDAO.getAllCoffee(order.getOrder_id());
    //details.add(coffee.getCoffee_name());
    //coffeeAddOns = addonDAO.getAllAddons(order.getOrder_id());
    //details.add(coffee.getCoffee_name());
    //coffee = coffeeDAO.getCoffeePrice(order.getOrder_id());
    //details.add(coffee.getCoffee_name()); coffee = coffeeDAO.getCoffeePrice(order.getOrder_id());
    //details.add(coffee.getCoffee_name());
